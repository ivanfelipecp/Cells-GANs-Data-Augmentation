...
import numpy as np
import math
from cells import CellsDataset
...
# Weights
weights_generator = "weights/cgan_generator.pt"
weights_discriminator = "weights/cgan_discriminator.pt"
...
def sample_image(n_row, epoch, dirr):
    ...
    save_image(gen_imgs.data, dirr+'/epoch_%d.png' % epoch, nrow=n_row, normalize=True)
...
for epoch in range(opt.n_epochs):
    ...
    sample_image(n_row=10, epoch=epoch, dirr=samples_path)
