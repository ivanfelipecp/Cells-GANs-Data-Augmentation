...
# Weights
weights_generator = "weights/wgan_gp_generator.pt"
weights_discriminator = "weights/wgan_gp_discriminator.pt"
...
for epoch in range(opt.n_epochs):
    ...
    save_image(fake_imgs.data[:25], samples_path+"/epoch_%d.png" % epoch, nrow=5, normalize=True)
